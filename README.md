...
| `:2.8.0-curl-git-jq-sops-alpine-3.13` | [View](variants/2.8.0-curl-git-jq-sops-alpine-3.13 ) |
| `:2.7.0-alpine-3.13` | [View](variants/2.7.0-alpine-3.13 ) |
| `:2.7.0-sops-alpine-3.13` | [View](variants/2.7.0-sops-alpine-3.13 ) |
| `:2.7.0-curl-git-jq-sops-alpine-3.13` | [View](variants/2.7.0-curl-git-jq-sops-alpine-3.13 ) |
| `:2.8.0-alpine-3.12` | [View](variants/2.8.0-alpine-3.12 ) |
| `:2.8.0-sops-alpine-3.12` | [View](variants/2.8.0-sops-alpine-3.12 ) |
| `:2.8.0-curl-git-jq-sops-alpine-3.12` | [View](variants/2.8.0-curl-git-jq-sops-alpine-3.12 ) |
| `:2.7.0-alpine-3.12` | [View](variants/2.7.0-alpine-3.12 ) |
| `:2.7.0-sops-alpine-3.12` | [View](variants/2.7.0-sops-alpine-3.12 ) |
| `:2.7.0-curl-git-jq-sops-alpine-3.12` | [View](variants/2.7.0-curl-git-jq-sops-alpine-3.12 ) |
